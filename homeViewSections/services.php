...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="service-outer-div">
            <div class="service-inner-div">
                <div class="service-img"></div>
                <div id="service-img-text4" style="margin: 20px;">[Service Description 4]</div>
        ...
        <div class="service-outer-div">
            <div class="service-inner-div">
                <div class="service-img"></div>
                <div id="service-img-text5" style="margin: 20px;">[Service Description 5]</div>
        ...
        <div class="service-outer-div">
            <div class="service-inner-div">
                <div class="service-img"></div>
                <div id="service-img-text6" style="margin: 20px;">[Service Description 6]</div>
